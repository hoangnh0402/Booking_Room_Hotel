...
public class DbMapper {
    ...
    public DbMapper() {
        ...
        typeConverterMap.put(LocalDate.class, (tuple, field) -> tuple.get(field, LocalDate.class));
        typeConverterMap.put(LocalDateTime.class, (tuple, field) -> tuple.get(field, LocalDateTime.class));
        ...
        for (Field field : clazz.getDeclaredFields()) {
            ...
            if (dbColumnMapper != null) {
                ...
                try {
                    ...
                    String label = ObjectUtils.isEmpty(this.getAnnotationValue(dbColumnMapper)) ? StringUtils.camelToSnake(propPascalCase)
